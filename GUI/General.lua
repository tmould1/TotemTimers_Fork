            ...
            args = {
                ...
                timersonbuttons = {
                    ...
                    set = function(info, val)
                        ...
                        if XiTimers and XiTimers.timers then
                            for i=1,#XiTimers.timers do
                                if XiTimers.timers[i] then
                ...
                TimeColor = {
                    ...
                    set = function(info, r,g,b,a)
                        if not TotemTimers.ActiveProfile.TimeColor then TotemTimers.ActiveProfile.TimeColor = {r=1,g=1,b=1,a=1} end
                    ...
                    get = function(info)
                        local tc = TotemTimers.ActiveProfile.TimeColor or {r=1,g=1,b=1,a=1}
                ...
                TimerBarColor = {
                    ...
                    hasAlpha = true,
                    set = function(info, r,g,b,a)
                        if not TotemTimers.ActiveProfile.TimerBarColor then TotemTimers.ActiveProfile.TimerBarColor = {r=0.5,g=0.5,b=1.0,a=1.0} end
                    ...
                    get = function(info)
                        local tc = TotemTimers.ActiveProfile.TimerBarColor or {r=0.5,g=0.5,b=1.0,a=1.0}
                        return tc.r, tc.g, tc.b, tc.a
                    end,
                },
                CooldownAlpha = {
